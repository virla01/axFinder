 ...
 */
export function initAxFinder(containerId) {
...
function getIconForFile(fileName, type) {
    ...
    switch (extension) {
        ...
        case 'doc':
        case 'docx': return 'file-text'; // O un icono de Word
        case 'xls':
        case 'xlsx': return 'file-spreadsheet';
        case 'ppt':
        case 'pptx': return 'file-slideshow';
        case 'zip':
        case 'rar':
        case 'tar':
...
window.createFolder = createFolder; // Asegúrate de tener un botón para esto
window.uploadFiles = uploadFiles; // Y un input file
